...
import imma from '../assets/immaculada.png';
...
const Navbar = () => {
  ...
  return (
    <div className='bg-[#1e3a8a] flex justify-between items-center h-24   mx-auto px-4 text-white'>
      <img className='w-20 mx-auto mt-2' src={imma} alt="/" />
      ...
      <ul className='hidden md:flex'>
        ...
        <button className='p-4 hover:bg-[#fbbf24] rounded'>News</button>
        <button className='p-4 hover:bg-[#fbbf24] rounded'>Events</button>
