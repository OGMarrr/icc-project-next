...
const Navbar = () => {
  ...
  return (
    <div className='bg-[#245eda] flex justify-between items-center h-24   mx-auto px-4 text-white'>
      ...
      <ul className='hidden md:flex'>
        <button className='p-4 hover:bg-[#fbbf24] rounded'>Home</button>
        <button className='p-4 hover:bg-[#1e3a8a] rounded'>News</button>
        <button className='p-4 hover:bg-[#245eda] rounded'>Events</button>
